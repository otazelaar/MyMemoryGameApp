...
import com.otaz.mymemory.utils.*
...
class CreateActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        private const val PICK_PHOTO_CODE = 612
        private const val READ_EXTERNAL_PHOTOS_CODE = 313
    ...
    private fun saveDateToFirebase() {
    ...
    private fun launchIntentForPhotos() {
        ...
        startActivityForResult(Intent.createChooser(intent, "Choose Pics"), 612)
    }
}